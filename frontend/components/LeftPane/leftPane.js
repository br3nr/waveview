...
function leftPane({selectedServerId}) {
  ...
  return (
    <>
      <Box borderRadius="25px" backgroundColor="transparent" marginLeft={10} width="100%" height="flex" paddingBottom={4}>
        <Box height="50px" paddingLeft={5} paddingTop="15px">
        <Text as="b">
          Channels:
        </Text>
        </Box>
        <List paddingLeft={5} spacing={3}>
                  ...
                  <Flex>
                    <Icon viewBox="0 0 24 24" width="24px" height="24px" color="red"> 
                      <path
                        ...
                        fill={server.is_connected ? "#43b581" : speakerColor}
                      />
                    </Icon>
                  </Flex>
